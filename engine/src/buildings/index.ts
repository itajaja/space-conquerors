...
const buildingList: IBuildingType[] = [
  ...
  { kind: 'building', id: 'building_palace', name: 'Palace', cost: zeroResources({ gold: 500, iron: 100 }), productionTime: 3, description: 'Allows to gather double resources from the planet', maxPerPlayer: 1, technologyRequirements: { tech_centralization: true }, buildingRequirements: {} },
