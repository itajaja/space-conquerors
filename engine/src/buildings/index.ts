...
const buildingList: IBuildingType[] = [
  ...
  { kind: 'building', id: 'building_farm', name: 'Farm', cost: zeroResources({ gold: 300, iron: 10 }), productionTime: 2, description: 'Increases population maximum by 10', maxPerPlanet: 1, technologyRequirements: {}, buildingRequirements: {} },
  ...
  { kind: 'building', id: 'building_spaceYard3', name: 'Space yard lev.3', cost: zeroResources({ gold: 1000, iron: 200 }), productionTime: 2, description: 'Allows to build one large, medium or small ship at a time.', maxPerPlanet: 1, technologyRequirements: {}, buildingRequirements: {building_spaceYard1: true} },
  { kind: 'building', id: 'building_spaceYard4', name: 'Space yard lev.4', cost: zeroResources({ gold: 2000, iron: 400 }), productionTime: 2, description: 'Allows to build one huge, large, medium or small ship at a time.', maxPerPlanet: 1, technologyRequirements: {}, buildingRequirements: {building_spaceYard1: true} },
]
