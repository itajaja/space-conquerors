...
const techList: ITechnology[] = [
  ...
  { kind: 'tech', id: 'tech_dark_matter', name: 'Dark Matter', cost: zeroResources({ gold: 1500 }), productionTime: 3, description: 'Allows to build Dark matter quarry', technologyRequirements: { tech_gas1: true, tech_iron1: true, tech_advanced_farming: true}, level: 4, family: TechnologyFamily.CIVIL },
